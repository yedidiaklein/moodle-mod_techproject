...
$string['allworkers'] = 'All workers';
$string['aiheader'] = 'AI setup';
$string['aiinstructions'] = 'AI instructions';
$string['aiinstructions_help'] = 'Optional. This text is used once to generate tasks after creation and is not saved.';
$string['aiinstructions_prompt'] = 'Generate a JSON response that matches this schema exactly, and return JSON only: {$a}';
$string['aitaskgenerator'] = 'AI task generator';
$string['aiproviderunavailable'] = 'AI provider is not available.';
$string['aibadresponse'] = 'AI response could not be parsed.';
...
$string['closedtasksworkday'] = 'Closed tasks by workday';
$string['closedtasksworkerweek'] = 'Closed tasks by worker this week';
$string['noclosedtasksworkday'] = 'No closed tasks found on workdays for current selection.';
$string['noclosedtasksworkerweek'] = 'No tasks closed this week for current selection.';
$string['code'] = 'Code';
...
$string['projectdashboards'] = 'Project dashboards';
...
$string['userdashboard'] = 'My tasks dashboard';
...
$string['weight_help'] = '
<p>The criterion weight allows balancing influence of eacb criteria in the set. The balancing is performed using
